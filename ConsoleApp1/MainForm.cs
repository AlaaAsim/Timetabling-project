...
namespace ConsoleApp1
{
    public partial class MainForm : Form
    {
        ...
        {
            string division= cbDivision1.Text;
            int year = Convert.ToInt32(cbYear1.Text);
            int size = Convert.ToInt32( tbDivisionSize.Text);
            //c.insertdivisionsize(division,year,size);
